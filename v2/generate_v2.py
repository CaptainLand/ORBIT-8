...
pipeline.ENGINE_VERSION = "v2 hierarchical"
pipeline.RHYTHM_CHECKPOINT = ROOT / "v2" / "runs" / "orbit_v2_hierarchical_v1" / "best.pt"
...
def main() -> None:
    if "--designer" not in sys.argv:
        sys.argv.extend(["--designer", "SeaLandX feat. ORBIT-8 v2"])
    pipeline.main()
